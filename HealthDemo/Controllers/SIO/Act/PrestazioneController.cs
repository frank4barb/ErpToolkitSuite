...
namespace HealthDemo.Controllers.SIO.Act
{
    public class PrestazioneController : ControllerErp
    {
        ...
        public ActionResult Index(SelPrestazione selobj)
        {
            ...
            //carica lista
            try { this.List = ErpContext.Instance.DogFactory.GetDog(dogId).List<Prestazione>(this.Select, xrefTables, ref this._dogCache, ""); }  // non carico tabelle relazionate per la lista di selezione
