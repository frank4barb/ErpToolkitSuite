...
namespace HealthDemo.Controllers.SIO.Act
{
    public class TipoCampioneController : ControllerErp
    {
        ...
        public ActionResult Index(SelTipoCampione selobj)
        {
            ...
            //carica lista
            try { this.List = ErpContext.Instance.DogFactory.GetDog(dogId).List<TipoCampione>(this.Select, xrefTables, ref this._dogCache, ""); }  // non carico tabelle relazionate per la lista di selezione
