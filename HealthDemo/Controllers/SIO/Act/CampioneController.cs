...
namespace HealthDemo.Controllers.SIO.Act
{
    public class CampioneController : ControllerErp
    {
        ...
        public ActionResult Index(SelCampione selobj)
        {
            ...
            //carica lista
            try { this.List = ErpContext.Instance.DogFactory.GetDog(dogId).List<Campione>(this.Select, xrefTables, ref this._dogCache, ""); }  // non carico tabelle relazionate per la lista di selezione
