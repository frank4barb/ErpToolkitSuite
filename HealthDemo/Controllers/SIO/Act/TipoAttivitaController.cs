...
namespace HealthDemo.Controllers.SIO.Act
{
    public class TipoAttivitaController : ControllerErp
    {
        ...
        public ActionResult Index(SelTipoAttivita selobj)
        {
            ...
            //carica lista
            try { this.List = ErpContext.Instance.DogFactory.GetDog(dogId).List<TipoAttivita>(this.Select, xrefTables, ref this._dogCache, ""); }  // non carico tabelle relazionate per la lista di selezione
