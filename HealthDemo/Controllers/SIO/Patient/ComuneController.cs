...
namespace HealthDemo.Controllers.SIO.Patient
{
    public class ComuneController : ControllerErp
    {
        ...
        public ActionResult Index(SelComune selobj)
        {
            ...
            //carica lista
            try { this.List = ErpContext.Instance.DogFactory.GetDog(dogId).List<Comune>(this.Select, xrefTables, ref this._dogCache, ""); }  // non carico tabelle relazionate per la lista di selezione
