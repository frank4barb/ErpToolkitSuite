...
namespace HealthDemo.Controllers.SIO.Patient
{
    public class PazienteController : ControllerErp
    {
        ...
        public ActionResult Index(SelPaziente selobj)
        {
            ...
            //carica lista
            try { this.List = ErpContext.Instance.DogFactory.GetDog(dogId).List<Paziente>(this.Select, xrefTables, ref this._dogCache, ""); }  // non carico tabelle relazionate per la lista di selezione
