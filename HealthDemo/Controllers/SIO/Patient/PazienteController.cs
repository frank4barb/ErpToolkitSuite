...
namespace HealthDemo.Controllers.SIO.Patient
{
    public class PazienteController : ControllerErp
    {
        ...
        {
            return base.ViewBlobModel<Paziente>(icode);
        }
        ...
        public ActionResult Index(SelPaziente selobj)
        {
            ...
            //carica lista
            try { this.List = ErpContext.Instance.DogFactory.GetDog(dogId).List<Paziente>(this.Select, xrefTables, ref this._dogCache, null, -1); }  
