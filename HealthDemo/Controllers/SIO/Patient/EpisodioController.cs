...
namespace HealthDemo.Controllers.SIO.Patient
{
    public class EpisodioController : ControllerErp
    {
        ...
        {
            return base.ViewBlobModel<Episodio>(icode);
        }
        ...
        public ActionResult Index(SelEpisodio selobj)
        {
            ...
            //carica lista
            try { this.List = ErpContext.Instance.DogFactory.GetDog(dogId).List<Episodio>(this.Select, xrefTables, ref this._dogCache, null, -1); }  
