...
namespace HealthDemo.Controllers.SIO.Resource
{
    public class MaterialeController : ControllerErp
    {
        ...
        {
            return base.ViewBlobModel<Materiale>(icode);
        }
        ...
        public ActionResult Index(SelMateriale selobj)
        {
            ...
            //carica lista
            try { this.List = ErpContext.Instance.DogFactory.GetDog(dogId).List<Materiale>(this.Select, xrefTables, ref this._dogCache, null, -1); }  
