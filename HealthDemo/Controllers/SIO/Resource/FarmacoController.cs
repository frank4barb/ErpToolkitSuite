...
namespace HealthDemo.Controllers.SIO.Resource
{
    public class FarmacoController : ControllerErp
    {
        ...
        public ActionResult Index(SelFarmaco selobj)
        {
            ...
            //carica lista
            try { this.List = ErpContext.Instance.DogFactory.GetDog(dogId).List<Farmaco>(this.Select, xrefTables, ref this._dogCache, ""); }  // non carico tabelle relazionate per la lista di selezione
