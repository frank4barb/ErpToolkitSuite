...
namespace HealthDemo.Controllers.SIO.Resource
{
    public class FarmacoController : ControllerErp
    {
        ...
        {
            return base.ViewBlobModel<Farmaco>(icode);
        }
        ...
        public ActionResult Index(SelFarmaco selobj)
        {
            ...
            //carica lista
            try { this.List = ErpContext.Instance.DogFactory.GetDog(dogId).List<Farmaco>(this.Select, xrefTables, ref this._dogCache, null, -1); }  
