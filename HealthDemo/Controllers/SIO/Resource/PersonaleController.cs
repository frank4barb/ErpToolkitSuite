...
namespace HealthDemo.Controllers.SIO.Resource
{
    public class PersonaleController : ControllerErp
    {
        ...
        public ActionResult Index(SelPersonale selobj)
        {
            ...
            //carica lista
            try { this.List = ErpContext.Instance.DogFactory.GetDog(dogId).List<Personale>(this.Select, xrefTables, ref this._dogCache, ""); }  // non carico tabelle relazionate per la lista di selezione
