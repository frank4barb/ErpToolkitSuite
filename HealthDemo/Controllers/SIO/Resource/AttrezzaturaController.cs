...
namespace HealthDemo.Controllers.SIO.Resource
{
    public class AttrezzaturaController : ControllerErp
    {
        ...
        {
            return base.ViewBlobModel<Attrezzatura>(icode);
        }
        ...
        public ActionResult Index(SelAttrezzatura selobj)
        {
            ...
            //carica lista
            try { this.List = ErpContext.Instance.DogFactory.GetDog(dogId).List<Attrezzatura>(this.Select, xrefTables, ref this._dogCache, null, -1); }  
