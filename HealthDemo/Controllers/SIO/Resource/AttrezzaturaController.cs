...
namespace HealthDemo.Controllers.SIO.Resource
{
    public class AttrezzaturaController : ControllerErp
    {
        ...
        public ActionResult Index(SelAttrezzatura selobj)
        {
            ...
            //carica lista
            try { this.List = ErpContext.Instance.DogFactory.GetDog(dogId).List<Attrezzatura>(this.Select, xrefTables, ref this._dogCache, ""); }  // non carico tabelle relazionate per la lista di selezione
