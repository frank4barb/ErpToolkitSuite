...
namespace HealthDemo.Controllers.SIO.Resource
{
    public class SalaController : ControllerErp
    {
        ...
        public ActionResult Index(SelSala selobj)
        {
            ...
            //carica lista
            try { this.List = ErpContext.Instance.DogFactory.GetDog(dogId).List<Sala>(this.Select, xrefTables, ref this._dogCache, ""); }  // non carico tabelle relazionate per la lista di selezione
