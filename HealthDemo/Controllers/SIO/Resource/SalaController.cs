...
namespace HealthDemo.Controllers.SIO.Resource
{
    public class SalaController : ControllerErp
    {
        ...
        {
            return base.ViewBlobModel<Sala>(icode);
        }
        ...
        public ActionResult Index(SelSala selobj)
        {
            ...
            //carica lista
            try { this.List = ErpContext.Instance.DogFactory.GetDog(dogId).List<Sala>(this.Select, xrefTables, ref this._dogCache, null, -1); }  
