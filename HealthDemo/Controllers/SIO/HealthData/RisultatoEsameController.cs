...
namespace HealthDemo.Controllers.SIO.HealthData
{
    public class RisultatoEsameController : ControllerErp
    {
        ...
        {
            return base.ViewBlobModel<RisultatoEsame>(icode);
        }
        ...
        public ActionResult Index(SelRisultatoEsame selobj)
        {
            ...
            //carica lista
            try { this.List = ErpContext.Instance.DogFactory.GetDog(dogId).List<RisultatoEsame>(this.Select, xrefTables, ref this._dogCache, null, -1); }  
