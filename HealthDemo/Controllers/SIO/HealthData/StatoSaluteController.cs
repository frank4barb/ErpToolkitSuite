...
namespace HealthDemo.Controllers.SIO.HealthData
{
    public class StatoSaluteController : ControllerErp
    {
        ...
        public ActionResult Index(SelStatoSalute selobj)
        {
            ...
            //carica lista
            try { this.List = ErpContext.Instance.DogFactory.GetDog(dogId).List<StatoSalute>(this.Select, xrefTables, ref this._dogCache, ""); }  // non carico tabelle relazionate per la lista di selezione
