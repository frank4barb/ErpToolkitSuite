...
namespace HealthDemo.Controllers.SIO.HealthData
{
    public class TipoDatoClinicoController : ControllerErp
    {
        ...
        {
            return base.ViewBlobModel<TipoDatoClinico>(icode);
        }
        ...
        public ActionResult Index(SelTipoDatoClinico selobj)
        {
            ...
            //carica lista
            try { this.List = ErpContext.Instance.DogFactory.GetDog(dogId).List<TipoDatoClinico>(this.Select, xrefTables, ref this._dogCache, null, -1); }  
