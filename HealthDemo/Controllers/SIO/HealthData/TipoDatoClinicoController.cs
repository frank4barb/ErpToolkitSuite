    ...
    public class TipoDatoClinicoController : ControllerErp
    {
        ...
        public JsonResult AutocompleteGetAll(string? modelPropertyName = null, [FromQuery] List<string> extraFieldNames = null)
        {
            try
            {
                ...
                return Json(ErpContext.Instance.DogFactory.GetDog(dogId).AutocompleteGetAll<TipoDatoClinico>(modelPropertyName: modelPropertyName, extraFieldNames: extraFieldNames));
            }
