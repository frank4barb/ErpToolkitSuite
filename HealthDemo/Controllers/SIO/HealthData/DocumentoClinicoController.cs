...
namespace HealthDemo.Controllers.SIO.HealthData
{
    public class DocumentoClinicoController : ControllerErp
    {
        ...
        {
            return base.ViewBlobModel<DocumentoClinico>(icode);
        }
        ...
        public ActionResult Index(SelDocumentoClinico selobj)
        {
            ...
            //carica lista
            try { this.List = ErpContext.Instance.DogFactory.GetDog(dogId).List<DocumentoClinico>(this.Select, xrefTables, ref this._dogCache, null, -1); }  
