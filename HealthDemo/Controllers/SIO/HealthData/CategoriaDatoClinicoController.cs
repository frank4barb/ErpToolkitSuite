...
namespace HealthDemo.Controllers.SIO.HealthData
{
    public class CategoriaDatoClinicoController : ControllerErp
    {
        ...
        public ActionResult Index(SelCategoriaDatoClinico selobj)
        {
            ...
            //carica lista
            try { this.List = ErpContext.Instance.DogFactory.GetDog(dogId).List<CategoriaDatoClinico>(this.Select, xrefTables, ref this._dogCache, ""); }  // non carico tabelle relazionate per la lista di selezione
