...
namespace HealthDemo.Controllers.SIO.Costs
{
    public class TipoDiagnosiController : ControllerErp
    {
        ...
        public ActionResult Index(SelTipoDiagnosi selobj)
        {
            ...
            //carica lista
            try { this.List = ErpContext.Instance.DogFactory.GetDog(dogId).List<TipoDiagnosi>(this.Select, xrefTables, ref this._dogCache, ""); }  // non carico tabelle relazionate per la lista di selezione
