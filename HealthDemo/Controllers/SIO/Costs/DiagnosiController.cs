...
namespace HealthDemo.Controllers.SIO.Costs
{
    public class DiagnosiController : ControllerErp
    {
        ...
        {
            return base.ViewBlobModel<Diagnosi>(icode);
        }
        ...
        public ActionResult Index(SelDiagnosi selobj)
        {
            ...
            //carica lista
            try { this.List = ErpContext.Instance.DogFactory.GetDog(dogId).List<Diagnosi>(this.Select, xrefTables, ref this._dogCache, null, -1); }  
