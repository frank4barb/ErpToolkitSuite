...
public override string ToString() { return $"{TdCodice} - {TdDescrizione}"; } 
public override string ToHtml() { return $"<strong>{HttpUtility.HtmlEncode(TdCodice)}</strong> {HttpUtility.HtmlEncode(TdDescrizione)}"; } 
