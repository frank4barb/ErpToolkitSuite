...
public override string ToString() { return $"{EpCodEpisodio} - {EpNote}"; } 
public override string ToHtml() { return $"<strong>{HttpUtility.HtmlEncode(EpCodEpisodio)}</strong> {HttpUtility.HtmlEncode(EpNote)}"; } 
