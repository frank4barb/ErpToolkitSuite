...
public override string ToString() { return $"{DiCodice} - {DiNome}"; } 
public override string ToHtml() { return $"<strong>{HttpUtility.HtmlEncode(DiCodice)}</strong> {HttpUtility.HtmlEncode(DiNome)}"; } 
