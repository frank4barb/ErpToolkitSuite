...
public override string ToString() { return $"{NzCodice} - {NzNome}"; } 
public override string ToHtml() { return $"<strong>{HttpUtility.HtmlEncode(NzCodice)}</strong> {HttpUtility.HtmlEncode(NzNome)}"; } 
