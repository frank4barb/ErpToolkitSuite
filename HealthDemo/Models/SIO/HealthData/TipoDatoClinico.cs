...
public override string ToString() { return $"{TcCodice} - {TcDescrizione}"; } 
public override string ToHtml() { return $"<strong>{HttpUtility.HtmlEncode(TcCodice)}</strong> {HttpUtility.HtmlEncode(TcDescrizione)}"; } 
