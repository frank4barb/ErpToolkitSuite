...
[AutocompleteServer("Episodio", "AutocompleteGetSelect", "AutocompletePreLoad", 1, ExtraFilter:"EP_ID_PAZIENTE IN ({DogManager.addParam(f0(\"PvIdPaziente\"), ref parameters)})", ExtraFields: "PvIdPaziente")]
[DataType(DataType.Text)]
