...
public override string ToString() { return $"{Pv1Icode} - {PvNote}"; } 
public override string ToHtml() { return $"<strong>{HttpUtility.HtmlEncode(Pv1Icode)}</strong> {HttpUtility.HtmlEncode(PvNote)}"; } 
