...
public override string ToString() { return $"{Re1Icode} - {ReNote}"; } 
public override string ToHtml() { return $"<strong>{HttpUtility.HtmlEncode(Re1Icode)}</strong> {HttpUtility.HtmlEncode(ReNote)}"; } 
