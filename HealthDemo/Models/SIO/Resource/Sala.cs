...
public override string ToString() { return $"{SaCodice} - {SaDescrizione}"; } 
public override string ToHtml() { return $"<strong>{HttpUtility.HtmlEncode(SaCodice)}</strong> {HttpUtility.HtmlEncode(SaDescrizione)}"; } 
