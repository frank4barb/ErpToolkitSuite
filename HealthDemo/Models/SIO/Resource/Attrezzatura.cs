...
public override string ToString() { return $"{AtCodice} - {AtDescrizione}"; } 
public override string ToHtml() { return $"<strong>{HttpUtility.HtmlEncode(AtCodice)}</strong> {HttpUtility.HtmlEncode(AtDescrizione)}"; } 
