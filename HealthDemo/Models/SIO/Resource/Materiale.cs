...
public override string ToString() { return $"{MtCodice} - {MtDescrizione}"; } 
public override string ToHtml() { return $"<strong>{HttpUtility.HtmlEncode(MtCodice)}</strong> {HttpUtility.HtmlEncode(MtDescrizione)}"; } 
