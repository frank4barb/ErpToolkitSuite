...
public override string ToString() { return $"{TeCodice} - {TeDescrizione}"; } 
public override string ToHtml() { return $"<strong>{HttpUtility.HtmlEncode(TeCodice)}</strong> {HttpUtility.HtmlEncode(TeDescrizione)}"; } 
