...
public List<HealthDemo.Models.SIO.Act.RelAttivitaTipoCampione> RelAttivitaTipoCampione4AcIdTipoCampione  { get; set; } = new List<HealthDemo.Models.SIO.Act.RelAttivitaTipoCampione>();
