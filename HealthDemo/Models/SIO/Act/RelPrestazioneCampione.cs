...
public const string SqlXdataIcodeName = "PC_X__ICODE";
public const string SqlXdataDeletedName = "PC_X__DELETED";
public const string SqlXdataTimestampName = "PC_X__TIMESTAMP";
public const string SqlXdataCdateName = "PC_X__CDATE";
public const string SqlXdataCtimeName = "PC_X__CTIME";
public const string SqlXdataCagentName = "PC_X__CAGENT";
public const string SqlXdataCunitName = "PC_X__CUNIT";
public const string SqlXdataMdateName = "PC_X__MDATE";
public const string SqlXdataMtimeName = "PC_X__MTIME";
public const string SqlXdataMagentName = "PC_X__MAGENT";
public const string SqlXdataMunitName = "PC_X__MUNIT";
public const string SqlXdataHomeName = "PC_X__HOME";
public const string SqlXdataVersionName = "PC_X__VERSION";
public const string SqlXdataInactiveName = "PC_X__INACTIVE";
public const string SqlXdataExtattName = "PC_X__EXTATT";
public const string SqlXdataMrefName = "PC_X__MREF";
public const string SqlXdataSeqName = "PC_X__SEQ";
public const string SqlXdataDescrName = "PC_X__DESCR";
public const string SqlXdataFmtName = "PC_X__FMT";
public const string SqlXdataXdurlName = "PC_X__XDURL";
public const string SqlXdataXdatumName = "PC_X__XDATUM";
...
[ErpDogField("PC__ICODE", SqlFieldCustomCond="", SqlFieldNameExt="", SqlFieldOptions="[SID]", SqlFieldProperties="prop()")]
...
[ErpDogField("PC__DELETED", SqlFieldCustomCond="", SqlFieldNameExt="", SqlFieldOptions="[DEL]", SqlFieldProperties="prop()")]
[DataType(DataType.Text)]
...
[ErpDogField("PC__TIMESTAMP", SqlFieldCustomCond="", SqlFieldNameExt="", SqlFieldOptions="[TMS]", SqlFieldProperties="prop()")]
[DataType(DataType.Text)]
...
[ErpDogField("PC__CDATE", SqlFieldCustomCond="", SqlFieldNameExt="", SqlFieldOptions="[CDATE]", SqlFieldProperties="prop()")]
[DataType(DataType.Text)]
...
[ErpDogField("PC__CTIME", SqlFieldCustomCond="", SqlFieldNameExt="", SqlFieldOptions="[CTIME]", SqlFieldProperties="prop()")]
[DataType(DataType.Text)]
[StringLength(8, ErrorMessage = "Inserire massimo 8 caratteri")]
...
[ErpDogField("PC__CAGENT", SqlFieldCustomCond="", SqlFieldNameExt="", SqlFieldOptions="[CAGENT]", SqlFieldProperties="prop()")]
[DataType(DataType.Text)]
[StringLength(12, ErrorMessage = "Inserire massimo 12 caratteri")]
...
[ErpDogField("PC__CUNIT", SqlFieldCustomCond="", SqlFieldNameExt="", SqlFieldOptions="[CUNIT]", SqlFieldProperties="prop()")]
[DataType(DataType.Text)]
[StringLength(12, ErrorMessage = "Inserire massimo 12 caratteri")]
...
[ErpDogField("PC__MDATE", SqlFieldCustomCond="", SqlFieldNameExt="", SqlFieldOptions="[MDATE]", SqlFieldProperties="prop()")]
[DataType(DataType.Text)]
[StringLength(10, ErrorMessage = "Inserire massimo 10 caratteri")]
...
[ErpDogField("PC__MTIME", SqlFieldCustomCond="", SqlFieldNameExt="", SqlFieldOptions="[MTIME]", SqlFieldProperties="prop()")]
[DataType(DataType.Text)]
[StringLength(8, ErrorMessage = "Inserire massimo 8 caratteri")]
...
[ErpDogField("PC__MAGENT", SqlFieldCustomCond="", SqlFieldNameExt="", SqlFieldOptions="[MAGENT]", SqlFieldProperties="prop()")]
[DataType(DataType.Text)]
[StringLength(12, ErrorMessage = "Inserire massimo 12 caratteri")]
...
[ErpDogField("PC__MUNIT", SqlFieldCustomCond="", SqlFieldNameExt="", SqlFieldOptions="[MUNIT]", SqlFieldProperties="prop()")]
[DataType(DataType.Text)]
[StringLength(12, ErrorMessage = "Inserire massimo 12 caratteri")]
...
[ErpDogField("PC__HOME", SqlFieldCustomCond="", SqlFieldNameExt="", SqlFieldOptions="[HOME]", SqlFieldProperties="prop()")]
[DataType(DataType.Text)]
[StringLength(12, ErrorMessage = "Inserire massimo 12 caratteri")]
public string? Pc1Home { get; set; }
[Display(Name = "Pc1Version", ShortName="", Description = "Versione dell'istanza", Prompt="")]
[ErpDogField("PC__VERSION", SqlFieldCustomCond="", SqlFieldNameExt="", SqlFieldOptions="[VERSION]", SqlFieldProperties="prop()")]
[DataType(DataType.Text)]
[StringLength(12, ErrorMessage = "Inserire massimo 12 caratteri")]
...
[ErpDogField("PC__INACTIVE", SqlFieldCustomCond="", SqlFieldNameExt="", SqlFieldOptions="[INACTIVE]", SqlFieldProperties="prop()")]
[DataType(DataType.Text)]
[StringLength(1, ErrorMessage = "Inserire massimo 1 caratteri")]
...
[ErpDogField("PC__EXTATT", SqlFieldCustomCond="", SqlFieldNameExt="", SqlFieldOptions="[EXTATT]", SqlFieldProperties="prop()")]
[DataType(DataType.Text)]
public string? Pc1Extatt { get; set; }


[Display(Name = "Id Campione", ShortName="", Description = "Codice del campione", Prompt="")]
[ErpDogField("PC_ID_CAMPIONE", SqlFieldCustomCond="", SqlFieldNameExt="", SqlFieldOptions="[MANDATORY]", Xref="Cp1Icode", SqlFieldProperties="prop() xref(CAMPIONE.CP__ICODE) xdup() multbxref()")]
[Required(ErrorMessage = "Inserire un valore nel campo")]
[AutocompleteServer("Campione", "AutocompleteGetSelect", "AutocompletePreLoad", 1, ExtraFilter:"", ExtraFields: "")]
[DataType(DataType.Text)]
...
[ErpDogField("PC_ID_PRESTAZIONE", SqlFieldCustomCond="", SqlFieldNameExt="", SqlFieldOptions="[MANDATORY]", Xref="Pr1Icode", SqlFieldProperties="prop() xref(PRESTAZIONE.PR__ICODE) xdup() multbxref()")]
[Required(ErrorMessage = "Inserire un valore nel campo")]
...
[ErpDogField("PC_TIPO", SqlFieldCustomCond="", SqlFieldNameExt="", SqlFieldOptions="", Xref="", SqlFieldProperties="prop() xref() xdup() multbxref()")]
[DefaultValue("E")]
[StringLength(1, ErrorMessage = "Inserire massimo 1 caratteri")]
...
[ErpDogField("PC_NOTE", SqlFieldCustomCond="", SqlFieldNameExt="", SqlFieldOptions="", Xref="", SqlFieldProperties="prop() xref() xdup() multbxref()")]
[DefaultValue(" ")]
...
[ErpDogField("PC_ID_TIPO_CAMPIONE", SqlFieldCustomCond="", SqlFieldNameExt="", SqlFieldOptions="", Xref="Tp1Icode", SqlFieldProperties="prop() xref(TIPO_CAMPIONE.TP__ICODE) xdup(CAMPIONE.CP_ID_TIPO_CAMPIONE[REL_PRESTAZIONE_CAMPIONE.PC_ID_CAMPIONE] {PC_ID_TIPO_CAMPIONE=' '}) multbxref()")]
