...
(function () {
    ...
    ////////    // 1) Ciclo stato (none -> asc -> desc -> none)
    ////////    const next = nextSortState(state);
    ////////    col.baseState = next;

    ////////    // 2) RICOSTRUZIONE COMPLETA DELL’ORDINE MULTI
    ////////    // ------------------------------------------------
    ////////    //    ⛔ niente più aggiunte/rimozioni incrementali
    ////////    //    ⛔ niente più vecchie sequenze
    ////////    //    ✔ nuovo ordine basato SOLO sugli stati correnti
    ////////    // ------------------------------------------------
    ////////    st.sorter.order = [];
