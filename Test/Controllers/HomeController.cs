...
namespace Test.Controllers
{
    ...
    public class HomeController : ControllerErp
    {
        ...
        {
            new DogManager.MenuItem("Home", "Home", "Index")
            ,new DogManager.MenuItem("Privacy", "Home", "Privacy")
            ,new DogManager.MenuItem("Mermaid", "Home", "Mermaid")
            ,new DogManager.MenuItem("Table", "Home", "Table")
            ,new DogManager.MenuItem("Direct Table1", "Datatable", "Table")
        };
        ...
        {
            return View(this);
            //return View("/ErpToolkit/Views/Home/Mermaid.cshtml", this);  //passo il Controller alla vista, come Model
            //return View("~/Views/Home/Mermaid.cshtml", this);  //passo il Controller alla vista, come Model
            //return View("/ErpToolkit/Views/Home/Mermaid.cshtml");  //passo il Controller alla vista, come Model
            //return View("Views/Home/Mermaid.cshtml");  
        }
        ...
        public async Task<IActionResult> Index(InputLogin Input)
        {
            ...
            if (ErpContextSession != null) ErpContextSession.ListMenu = SessionListMenu;  //per il momento il menù è uguale per tutti ma può essere distinto per utente
            // ... 
            // ... 
            // ... 
            // ... 
        ...
        public static readonly Dictionary<string, List<DogManager.Page>> PathMenu = new Dictionary<string, List<DogManager.Page>> {
            { "Home1", new List<DogManager.Page> { new DogManager.Page("Home") } }
            ,{ "Privacy1", new List<DogManager.Page> { new DogManager.Page("Privacy") } }
            ,{ "Mermaid1", new List<DogManager.Page> { new DogManager.Page("Mermaid") } }
            ,{ "Table1", new List<DogManager.Page> { new DogManager.Page("Page2") } }
            ,{ "Direct Table1", new List<DogManager.Page> { new DogManager.Page("Page2") } }
            ,{ "ERModel1", new List<DogManager.Page> { new DogManager.Page("Page2") } }
            ,{ "Direct Attivita1", new List<DogManager.Page> { new DogManager.Page("Page2") } }
            ,{ "Direct Episodio1", new List<DogManager.Page> { new DogManager.Page("Page2") } }
